...
// mongo docker - note: for docker BE to connect to docker DB, change 'localhost' to 'mongo'
exports.mongoDocker = async () => await mongoose.connect('mongodb://mongo:27017/mongo-test')
